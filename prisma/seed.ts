...
const medicines = [
  ...
  { name: "Ceftriaxone", strength: "1g", form: "Injectable", packaging: "Vial", category: "Antibiotics", batchNo: "B-13579-CFT", branch: "Adenta Main", manufacturer: "Roche", supplier: "CarePlus Distributors", stockCategory: "restricted", quantity: 70, unitPriceGhs: 28, expiryDate: daysFromNow(18) },
  ...
  { name: "Salbutamol Inhaler", strength: "100mcg", form: "Inhaler", packaging: "200 Dose", category: "Respiratory", batchNo: "B-33445-SAL", branch: "Adenta Main", manufacturer: "GSK", supplier: "PharmaSource Ltd", stockCategory: "essential", quantity: 12, unitPriceGhs: 55, expiryDate: daysFromNow(75) },
